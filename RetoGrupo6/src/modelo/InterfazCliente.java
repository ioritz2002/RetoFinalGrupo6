...
public interface InterfazCliente {
	...
	// Lista la columna de valoraciones de cada uno de los productos en la ventana
	// de productos
	...
	// Comprobar de que el producto ha sido previamente comprado para posteriormente
	// en otro metod valorar el producto
